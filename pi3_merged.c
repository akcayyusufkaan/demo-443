...
volatile uint8_t uart_print_water_flag = 0;
...
{
    // Just clear flag if something weird happens
    TIM7->SR = 0;
...
void update(void){
    if (uart_print_water_flag) {
        uart_print_water_flag = 0;  // clear flag first
